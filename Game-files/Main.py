...
def main():
    ...
    # Button positions
    button_a_rect = pygame.Rect(WINDOW_WIDTH - BUTTON_SIZE * 2 - 10, 5, BUTTON_SIZE, BUTTON_SIZE)
    ...
    while True:
        ...
        is_button_a_clicked = button_a_rect.collidepoint(mouse_pos) and mouse_pressed[0]
        is_button_b_clicked = button_b_rect.collidepoint(mouse_pos) and mouse_pressed[0]

        # Display buttons with click feedback
        draw_button('A', button_a_rect.x, button_a_rect.y, BUTTON_SIZE, is_button_a_clicked)
